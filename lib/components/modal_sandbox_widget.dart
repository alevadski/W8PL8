...
class ModalSandboxWidget extends StatefulWidget {
  const ModalSandboxWidget({Key? key}) : super(key: key);

  @override
  _ModalSandboxWidgetState createState() => _ModalSandboxWidgetState();
}

class _ModalSandboxWidgetState extends State<ModalSandboxWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.fromSTEB(16, 16, 16, 350),
        child: Container(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MODAL_SANDBOX_COMP_close_ICN_ON_TAP');
                      ...
                      Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MODAL_SANDBOX_COMP_Button_ON_TAP');
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MODAL_SANDBOX_COMP__BTN_ON_TAP');
                              logFirebaseEvent('Button_update_local_state');
                              FFAppState().lastAddedCustomSupColor =
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'MODAL_SANDBOX_COMP_SAVE_BTN_ON_TAP');
